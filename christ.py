...
print  """
\033[1;92m🐰°───────(China Oil)───────°🐰
\033[1;92m🐰°───────(Wag Nyo Nakawin Code ko!!)───────°🐰

"""

CorrectUsername = "christian"
CorrectPassword = "laguerta"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://www.youtube.com/channel/UClO03_tNVM5dEVZ1UnETmfg')
    else:
...
def login():
	...
	try:
		...
		print('          \033[1;97m[◉] \x1b[1;96mLogin Mo Facebook Acc mo Kahit Luma :) \033[1;97m[◉]' )
...
def menu():
	...
	print "\033[1;32;40m[2] \033[1;33;40m══Update Laguerta"																														
...
def pilih_super():
	...
	jalan('       \033[1;97mLaguerta start cloning Wait...')
	print  " \033[1;36;48m●════════════════════◄Laguerta►════════════════════●" 
